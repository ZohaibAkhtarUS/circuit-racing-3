...
const Audio = (() => {
    ...
    function setMuted(m) { muted = m; master && (master.gain.value = m ? 0 : 0.3); }
    ...
    function playHit(t, vol) {
        noise(0.3, vol * 0.4, t, 800);
        osc('sine', 80, 0.3, vol * 0.3, t);
    }

    function playHorn(t, vol) {
        osc('square', 340, 0.3, vol * 0.15, t);
        osc('square', 420, 0.3, vol * 0.1, t);
    }
    ...
    function playLightning(t, vol) {
        noise(0.5, vol * 0.5, t, 2000);
        osc('sawtooth', 60, 0.4, vol * 0.3, t);
    }
